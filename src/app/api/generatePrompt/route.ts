  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        ...
        {
          role: "user",
          content: `Convert the following description into a short prompt for AI image generation, keep it simple and concise. Prompt should start with "a repeating seamless illustrated vector pattern of ": ${input}`,
        },
      ],
    });
